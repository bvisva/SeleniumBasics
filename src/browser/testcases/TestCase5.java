...
public class TestCase5 {
	...
	public static void main(String[] args) {
		...
		// Negative Test Case
				...
				driver.findElement(By.id("formname")).sendKeys("Balaji Form 1");
	...
	//<div id="error_status"><span class="red">ERROR</span>: You aleady have a form named 'Balaji Form 1'. Please choose a unique name for your form.</div>
