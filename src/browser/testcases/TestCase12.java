...
public class TestCase12 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("Submit")).click();
		driver.findElement(By.id("subjectvalue")).sendKeys("101");
		driver.findElement(By.id("Submit")).click();
		driver.findElement(By.id("subjectvalue")).sendKeys("0");
		driver.findElement(By.id("Submit")).click();
		driver.findElement(By.id("subjectvalue")).sendKeys("-1");
		driver.findElement(By.id("Submit")).click();
		driver.findElement(By.id("subjectvalue")).sendKeys("A");
		driver.findElement(By.id("Submit")).click();
		driver.findElement(By.id("subjectvalue")).sendKeys("&");
		driver.findElement(By.id("Submit")).click();
