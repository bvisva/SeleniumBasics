...
public class TestCase9 {
	...
	public static void main(String[] args) {
		...
		driver.findElements(By.className("forms")).get(0).click();
		driver.findElement(By.id("Submit")).click();
		driver.findElement(By.id("subjectvalue")).sendKeys("rwerfggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg");
		driver.findElement(By.id("Submit")).click();
