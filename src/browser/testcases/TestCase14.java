...
public class TestCase14 {
	...
	public static void main(String[] args) {
		...
		driver.findElements(By.className("txt")).get(1).sendKeys("");
		driver.findElement(By.id("Submit")).click();
		driver.findElements(By.className("txt")).get(0).sendKeys("");
		driver.findElements(By.className("txt")).get(1).sendKeys("Test Plan 2");
		driver.findElement(By.id("Submit")).click();
		driver.findElements(By.className("txt")).get(0).sendKeys("");
		driver.findElements(By.className("txt")).get(1).sendKeys("");
		driver.findElement(By.id("Submit")).click();
		driver.findElements(By.className("txt")).get(0).sendKeys("rwerfggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg");
		driver.findElements(By.className("txt")).get(1).sendKeys("Test Plan 2");
		driver.findElement(By.id("Submit")).click();
		driver.findElements(By.className("txt")).get(0).sendKeys("Test Plan 1");
		driver.findElements(By.className("txt")).get(1).sendKeys("rwerfggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg");
		driver.findElement(By.id("Submit")).click();
